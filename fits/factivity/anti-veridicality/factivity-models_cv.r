...
output_dir <- "fits/factivity/anti-veridicality/results/";
## adjust as desired.
...
for (n in model_names) {
    for (f in 1:K) {
        ...
        model_path <- file.path("models/factivity/anti-veridicality/",paste0(n,"_cv.stan"));
        ...
        model_fit <- model$sample(
                               ...
                               iter_warmup=5*N_samples,
                               iter_sampling=5*N_samples,
			       thin=5,
                               adapt_delta=0.99,
